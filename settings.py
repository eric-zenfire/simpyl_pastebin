...
# Django settings for simpyl_pastebin project.
...
DATABASE_NAME = 'simpyl.dat'             # Or path to database file if using sqlite3.
...
MEDIA_ROOT = 'simpyl_pastebin/pastebin/static/'
...
ROOT_URLCONF = 'simpyl_pastebin.urls'
